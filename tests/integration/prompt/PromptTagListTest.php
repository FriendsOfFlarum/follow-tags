...
class PromptTagListTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->prepareDatabase([
            ...
            'tags' => array_merge($this->tags(), [
                ['id' => 7, 'name' => 'Secondary', 'slug' => 'secondary', 'position' => null, 'parent_id' => null],
            ]),
        ]);
    }
    ...
    public function restricted_tags_are_included_for_actors_who_can_see_them()
    {
        ...
        $this->assertEquals([1, 2, 3, 4], $this->promptTagIds(1));
    }
    ...
    public function primary_and_secondary_strategy()
    {
        ...
        $this->assertEquals([1, 2, 3, 7], $this->promptTagIds(2));
    }
    ...
    public function secondary_strategy()
    {
        ...
        $this->assertEquals([7], $this->promptTagIds(2));
    }
    ...
    public function all_strategy()
    {
        ...
        $this->assertEquals([1, 2, 3, 5, 6, 7], $this->promptTagIds(2));
    }
